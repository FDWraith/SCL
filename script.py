                ...
                if c == 'box':
                    ...
                    if args[3]:
                        if args[3] not in knobTable:
                            ...
                            tmp = make_translate(args[0] * knobTable[args[3]], args[1] * knobTable[args[3]], args[2] * knobTable[args[3]])
                    else:
                        tmp = make_translate(args[0], args[1], args[2])
                    matrix_mult(stack[-1], tmp)
                    ...
                    if args[3]:
                        if args[3] not in knobTable:
                            ...
                            tmp = make_scale(args[0] * knobTable[args[3]], args[1] * knobTable[args[3]], args[2] * knobTable[args[3]])
                    else:
                        tmp = make_scale(args[0], args[1], args[2])
                    matrix_mult(stack[-1], tmp)
                    stack[-1] = [x[:] for x in tmp]
                    ...
                    if args[2]:
                        if args[2] not in knobTable:
                            ...
                            theta = args[1] * (math.pi/180) * knobTable[args[2]]
                    else:
                        theta = args[1] * (math.pi/180) 
                    if args[0] == 'x':
                        tmp = make_rotX(theta)
